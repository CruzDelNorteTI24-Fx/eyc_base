...
if (!eyc_is_admin() && !eyc_puede_vista('a-auditoria')) {
...
<head>
    ...
    <link rel="stylesheet" href="<?= eyc_asset('assets/css/auditoria_alm_eyc.css') ?>">
</head>
<body>
<?php eyc_render_header(['title' => 'Auditorias de almacen', 'subtitle' => 'Inventario operativo']); ?>
...
async function withLoading(options, task) {
    ...
    if (window.eycLoader && typeof window.eycLoader.during === 'function') {
        return window.eycLoader.during(run, {
