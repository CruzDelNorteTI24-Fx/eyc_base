...
require_once __DIR__ . '/../layout/quick_scan_eyc.php';
require_once __DIR__ . '/../layout/bus_lookup_eyc.php';
require_once __DIR__ . '/../layout/almacen_movimiento_eyc.php';

if (!eyc_is_admin() && (!eyc_puede_modulo(3) || !eyc_puede_vista('a-formulreg'))) {
...
<head>
    <meta charset="UTF-8">
    <title>Registro de movimientos | Eyc</title>
    ...
    <link rel="stylesheet" href="<?= eyc_asset('assets/css/loader_eyc.css') ?>">
    <link rel="stylesheet" href="<?= eyc_asset('assets/css/dialog_eyc.css') ?>">
    <link rel="stylesheet" href="<?= eyc_asset('assets/css/almacen_movimiento_eyc.css') ?>">
</head>
<body>
<?php eyc_render_header(['title' => 'Registro de movimientos', 'subtitle' => 'Almacen operativo']); ?>
<?php eyc_render_sidebar(); ?>

<main class="main-content eyc-main eyc-main--module">
    <?php eyc_render_content_separator('top'); ?>

    <div class="eyc-main__inner alm-mov-page" id="almMovPage" data-api="movimiento_api.php" data-csrf="<?= alm_page_h($csrf) ?>" data-can-edit-prices="<?= $canEditPrices ? '1' : '0' ?>">
...
<?php eyc_render_almacen_product_catalog(); ?>
<?php eyc_render_almacen_salida_modal(); ?>
<?php eyc_render_footer(); ?>

<script>
window.eyc_NOTA_PDF_CONFIG = {
    endpoint: '<?= alm_page_h(eyc_base_url('php/nota_pdf_data.php')) ?>',
    ...
    logoTicket: '<?= alm_page_h(eyc_base_url('img/completo2.png')) ?>',
    footerLabel: 'Eyc'
};
</script>
...
<script src="<?= eyc_asset('assets/js/loader_eyc.js') ?>"></script>
<script src="<?= eyc_asset('assets/js/dialog_eyc.js') ?>"></script>
<script src="<?= eyc_asset('assets/js/almacen_movimiento_eyc.js') ?>"></script>
