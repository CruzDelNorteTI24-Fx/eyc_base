...
<head>
    ...
    <link rel="stylesheet" href="<?= eyc_asset('assets/css/kardex_eyc.css') ?>">
</head>
<body>
<?php eyc_render_sidebar(); ?>
<?php eyc_render_header(['title' => 'Kardex', 'subtitle' => 'Movimientos valorizados de almacen']); ?>

<div class="eyc-main">
    <?php eyc_render_content_separator('top'); ?>

    <main class="eyc-content eyc-stock-page eyc-kardex-page">
...
window.eyc_KARDEX_REPORT = {
    pdf: {
        ...
        logoLeft: '<?= kardex_h(eyc_base_url('img/icon.png')) ?>',
        logoRight: '<?= kardex_h(eyc_base_url('img/eyc_black.png')) ?>',
        useCover: false,
...
<script src="<?= eyc_asset('assets/js/kardex_eyc.js') ?>"></script>
