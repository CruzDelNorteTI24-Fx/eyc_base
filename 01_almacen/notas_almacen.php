...
<head>
    ...
    <title>Notas de almacén | Eyc</title>
    ...
    <link rel="stylesheet" href="<?= eyc_asset('assets/css/notas_almacen_eyc.css') ?>">
</head>
<body>
<?php eyc_render_header(['title' => 'Notas de almacén', 'subtitle' => 'Historial operativo']); ?>
...
<script>
window.eyc_NOTAS_ALMACEN = {
    endpoint: 'notas_almacen.php'
};
window.eyc_NOTA_PDF_CONFIG = {
    endpoint: '<?= notas_h(eyc_base_url('php/nota_pdf_data.php')) ?>',
    ...
    logoTicket: '<?= notas_h(eyc_base_url('img/completo2.png')) ?>',
    footerLabel: 'Eyc'
};
</script>
...
<script src="<?= eyc_asset('assets/js/notas_almacen_eyc.js') ?>"></script>
</body>
</html>
<?php
if (isset($conn) && $conn instanceof mysqli) {
