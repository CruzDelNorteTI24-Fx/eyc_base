...
$stmt_items = $conn->prepare("
    SELECT i.clm_item_id, i.clm_item_nombre, i.clm_items_tipo, i.clm_item_idtipocheck,
           r.clm_resultado_dfecd, r.clm__rescheck_conductor1, r.clm_resultado_estado, r.clm_rescheck_porcentaje1, r.clm_rescheck_imagen
...
while ($row_item = $res_items->fetch_assoc()) {
    ...
    switch ($tipo) {
        case 'T':
            $resultado = $row_item['clm__rescheck_conductor1'] ?? "";
            break;
        case 'O':
            $resultado = $row_item['clm__rescheck_conductor1'] ?? "";
            break;
    ...
    $items[] = [
        ...
        "data_completa" => [
            "texto" => $row_item['clm__rescheck_conductor1'] ?? "",
