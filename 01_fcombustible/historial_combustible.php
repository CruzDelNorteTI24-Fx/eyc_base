...
<head>
    ...
    <link rel="stylesheet" href="<?= eyc_asset('assets/css/combustible_historial_eyc.css') ?>">
</head>
<body>
<?php eyc_render_sidebar(); ?>
<?php eyc_render_header(['title' => 'Combustible', 'subtitle' => 'Historial operativo']); ?>

<div class="eyc-main">
    <?php eyc_render_content_separator('top'); ?>

    <main class="eyc-content eyc-stock-page eyc-comb-page">
