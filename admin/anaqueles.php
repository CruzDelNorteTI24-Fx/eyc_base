...
eyc_admin_render_head('Anaqueles');
?>
<?php eyc_render_header(['title' => 'Anaqueles', 'subtitle' => 'Administracion']); ?>
            ...
            <div class="admin-cat-table-wrap">
                <table class="admin-cat-table">
                    ...
                    <?php foreach ($anaqueles as $anaquel): ?>
                        <tr>
                            <td><?= eyc_admin_h($anaquel['clm_alm_anaquel_id'] ?? '') ?></td>
                            <td><div class="admin-cat-main"><strong><?= eyc_admin_h($anaquel['clm_alm_anaquel_nombre'] ?? '') ?></strong></div></td>
                            <td><span class="admin-cat-chip"><?= eyc_admin_h($anaquel['clm_alm_anaquel_codigo'] ?: 'Sin codigo') ?></span></td>
                            <td><?= eyc_admin_h($anaquel['sede_nombre'] ?: ($anaquel['clm_alm_anaquel_idSEDE'] ?? 'Sin sede')) ?></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
