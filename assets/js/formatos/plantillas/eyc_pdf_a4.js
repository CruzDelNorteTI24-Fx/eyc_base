(function (window, document) {
    ...
    function addDemoContent(doc, config) {
        ...
        doc.setFont('helvetica', 'normal');
        text(doc, 'Llama eycPDF.generateDemo({ orientation }) o reutiliza eycPDF.createDocument(...) para reportes reales.', left + 5, H - 27.5);
    }
    ...
    async function generateDemo(options) {
        ...
        doc.save(`eyc_formato_a4_${orientationLabel}.pdf`);
    }
