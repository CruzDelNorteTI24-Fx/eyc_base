...
if (!function_exists('eyc_alm_h')) {
    function eyc_alm_h($value): string {
        return htmlspecialchars((string)$value, ENT_QUOTES, 'UTF-8');
    }
}

if (!function_exists('eyc_render_almacen_product_catalog')) {
    function eyc_render_almacen_product_catalog(): void {
        ?>
...
if (!function_exists('eyc_render_almacen_salida_modal')) {
    function eyc_render_almacen_salida_modal(): void {
        ?>
