...
$csrfToken = eyc_csrf_token('login');
    ...
    <style>
        ...
        *::after {
        ...
        .field input {
            ...
            border: 0;
            border-bottom: 1px solid var(--eyc-line);
            border-radius: 0;
            outline: none;
        ...
        .field input:focus {
            border-color: var(--eyc-blue);
            box-shadow: 0 1px 0 var(--eyc-blue);
        }
        ...
        .login-button:hover {
            ...
            box-shadow: inset 0 -4px 0 var(--eyc-yellow), 0 10px 24px rgba(16, 24, 32, 0.13);
        }
        ...
        .error-message {
            ...
            gap: 10px;
            border-left: 3px solid var(--eyc-danger);
            background: var(--eyc-danger-bg);
            color: var(--eyc-danger);
            font-size: 13px;
            line-height: 1.45;
        }
