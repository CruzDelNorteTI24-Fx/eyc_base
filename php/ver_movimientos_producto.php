...
<style>
  ...
  .mp-hero-barcode .eyc-barcode-card{
  ...
  <section class="mp-hero">
    ...
    <div class="mp-hero-main">
      ...
      <div class="mp-hero-barcode">
        <div class="eyc-barcode-card eyc-barcode-card--flat eyc-barcode-card--compact"
            data-eyc-barcode
          ...
          <div class="eyc-barcode-actions">
            <span class="eyc-barcode-code"><?= h($barcode_codigo) ?></span>
